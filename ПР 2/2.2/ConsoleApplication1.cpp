...
int main()
{
	...
	cout << "Пересекается ли окружность 1 с окружностью 2 : " << circle1.check_circle(r2, x2, y2) << endl;
	cout << "Пересекается ли окружность 1 с окружностью 3 : " << circle1.check_circle(r3, x3, y3) << endl;
	cout << "Пересекается ли окружность 3 с окружностью 2 : " << circle3.check_circle(r2, x2, y2) << endl;
}
